...
export function useClassicGame(gameMode) {
  ...
  const pickNewRound = useCallback(() => {
    ...
    if (classicExerciseIdRef.current === 48) {
      const r = exercise48PickRound(ctx)
      roundRef.current = {
        kind: 'twoMa',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
    ...
    if (classicExerciseIdRef.current === 49) {
      const r = exercise49PickRound(ctx)
      roundRef.current = {
        kind: 'twoMd',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
    ...
    if (classicExerciseIdRef.current === 50) {
      const r = exercise50PickRound(ctx)
      roundRef.current = {
        kind: 'twoH',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
    ...
    if (classicExerciseIdRef.current === 51) {
      const { target, audioFile } = pickClassicOneNoteRoundEx51(ctx)
      roundRef.current = { kind: 'one', target, audioFile }
      return
    }
    if (classicExerciseIdRef.current === 52) {
      const r = exercise52PickRound(ctx)
      roundRef.current = {
        kind: 'twoMa',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
    ...
    if (classicExerciseIdRef.current === 53) {
      const r = exercise53PickRound(ctx)
      roundRef.current = {
        kind: 'twoMd',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
    ...
    if (classicExerciseIdRef.current === 54) {
      const r = exercise54PickRound(ctx)
      roundRef.current = {
        kind: 'twoH',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
    ...
    if (classicExerciseIdRef.current === 56) {
      const r = exercise56PickRound(ctx)
      roundRef.current = {
        kind: 'twoMa',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
    ...
    if (classicExerciseIdRef.current === 57) {
      const r = exercise57PickRound(ctx)
      roundRef.current = {
        kind: 'twoMd',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
    ...
    if (classicExerciseIdRef.current === 58) {
      const r = exercise58PickRound(ctx)
      roundRef.current = {
        kind: 'twoH',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
    ...
    if (classicExerciseIdRef.current === 59) {
      const { target, audioFile } = pickClassicOneNoteRoundEx59(ctx)
      roundRef.current = { kind: 'one', target, audioFile }
      return
    }
    if (classicExerciseIdRef.current === 60) {
      const r = exercise60PickRound(ctx)
      roundRef.current = {
        kind: 'twoMa',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
    ...
    if (classicExerciseIdRef.current === 61) {
      const r = exercise61PickRound(ctx)
      roundRef.current = {
        kind: 'twoMd',
        exercise25Slots: { slot0: r.slot0, slot1: r.slot1 },
        audioFileLow: r.audioFileLow,
  ...
  const handleClassicExerciseSelectChange = useCallback(
    (e) => {
      ...
      let id = CLASSIC_EXERCISE_IDS_IN_ORDER.includes(raw) ? raw : 1
      if (id === 2 || id === 3) id = 4
  ...
  const handleWhitePress = useCallback(
    (index, label) => {
        ...
        if (label === target) {
          ...
          setStreak((s) => {
            ...
            if (
              ...
              window.setTimeout(() => {
                classicExerciseIdRef.current = 48
                setClassicExerciseId(48)
                rollVerificationHalf(verificationHalfRef)
                setStreak(0)
                frozenRef.current = false
                setShowCorrectNotice(false)
            ...
            if (
              ...
              window.setTimeout(() => {
                classicExerciseIdRef.current = 56
                setClassicExerciseId(56)
                rollVerificationHalf(verificationHalfRef)
                setStreak(0)
                frozenRef.current = false
                setShowCorrectNotice(false)
      ...
      /* Exercício 48 — MA diminuto 2: C, D#/Eb, F#/Gb, A (duas pretas). */
      if (
        classicExerciseIdRef.current === 48 &&
        round.kind === 'twoMa' &&
        round.exercise25Slots
        ...
        const { slot0, slot1 } = round.exercise25Slots
        const isDim2Black = (kind) => kind === 'dsharp' || kind === 'fsharp'

        if (answerPhaseRef.current === 0) {
          if (isDim2Black(slot0.kind)) {
            frozenRef.current = true
            handleWrongAnswer()
            return
          }
      ...
      /* Exercício 60 — MA diminutos 1 e 3: C#/Db, D, E, F, G, G#/Ab, A#/Bb, B (três pretas). */
      if (
        classicExerciseIdRef.current === 60 &&
        round.kind === 'twoMa' &&
        round.exercise25Slots
        ...
        const { slot0, slot1 } = round.exercise25Slots
        const isDim13Black = (kind) =>
          kind === 'gsharp' || kind === 'csharp' || kind === 'asharp'

        if (answerPhaseRef.current === 0) {
          if (isDim13Black(slot0.kind)) {
            frozenRef.current = true
            handleWrongAnswer()
            return
          }
        ...
        setStreak((s) => {
          ...
          if (
            ...
            window.setTimeout(() => {
              classicExerciseIdRef.current = 61
              setClassicExerciseId(61)
              rollVerificationHalf(verificationHalfRef)
              setStreak(0)
              frozenRef.current = false
              setShowCorrectNotice(false)
      ...
      /* Exercício 61 — MD diminutos 1 e 3: C#/Db, D, E, F, G, G#/Ab, A#/Bb, B (três pretas). */
      if (
        classicExerciseIdRef.current === 61 &&
        round.kind === 'twoMd' &&
        round.exercise25Slots
      ...
      /* Exercício 56 — MA diminutos 1 e 2: C, D, D#/Eb, F, F#/Gb, G#/Ab, A, B (três pretas). */
      if (
        classicExerciseIdRef.current === 56 &&
        round.kind === 'twoMa' &&
        round.exercise25Slots
        ...
        const { slot0, slot1 } = round.exercise25Slots
        const isDim12Black = (kind) =>
          kind === 'gsharp' || kind === 'dsharp' || kind === 'fsharp'

        if (answerPhaseRef.current === 0) {
          if (isDim12Black(slot0.kind)) {
            frozenRef.current = true
            handleWrongAnswer()
            return
          }
        ...
        setStreak((s) => {
          ...
          if (
            ...
            window.setTimeout(() => {
              classicExerciseIdRef.current = 57
              setClassicExerciseId(57)
              rollVerificationHalf(verificationHalfRef)
              setStreak(0)
              frozenRef.current = false
              setShowCorrectNotice(false)
      ...
      /* Exercício 57 — MD diminutos 1 e 2: C, D, D#/Eb, F, F#/Gb, G#/Ab, A, B (três pretas). */
      if (
        classicExerciseIdRef.current === 57 &&
        round.kind === 'twoMd' &&
        round.exercise25Slots
      ...
      /* Exercício 52 — MA diminuto 3: C#/Db, E, G, A#/Bb (duas pretas). */
      if (
        classicExerciseIdRef.current === 52 &&
        round.kind === 'twoMa' &&
        round.exercise25Slots
        ...
        const { slot0, slot1 } = round.exercise25Slots
        const isDim3Black = (kind) => kind === 'csharp' || kind === 'asharp'

        if (answerPhaseRef.current === 0) {
          if (isDim3Black(slot0.kind)) {
            frozenRef.current = true
            handleWrongAnswer()
            return
          }
        ...
        setStreak((s) => {
          ...
          if (
            ...
            window.setTimeout(() => {
              classicExerciseIdRef.current = 53
              setClassicExerciseId(53)
              rollVerificationHalf(verificationHalfRef)
              setStreak(0)
              frozenRef.current = false
              setShowCorrectNotice(false)
      ...
      /* Exercício 53 — MD diminuto 3: C#/Db, E, G, A#/Bb (duas pretas). */
      if (
        classicExerciseIdRef.current === 53 &&
        round.kind === 'twoMd' &&
        round.exercise25Slots
      ...
      /* Exercício 49 — MD diminuto 2: C, D#/Eb, F#/Gb, A (duas pretas). */
      if (
        classicExerciseIdRef.current === 49 &&
        round.kind === 'twoMd' &&
        round.exercise25Slots
  ...
  const handleBlackPress = useCallback(
    (blackKeyIndex) => {
      ...
      if (classicExerciseIdRef.current === 51 && round.kind === 'one') {
        ...
        setStreak((s) => {
          ...
          if (next >= VERIFICATION_TARGET && classicExerciseIdRef.current === 51) {
            window.setTimeout(() => {
              classicExerciseIdRef.current = 52
              setClassicExerciseId(52)
              rollVerificationHalf(verificationHalfRef)
      ...
      if (classicExerciseIdRef.current === 59 && round.kind === 'one') {
        const isGs = blackKeyIndex === gsharpIdx && round.target === 'G#'
        const isCs = blackKeyIndex === csharpIdx && round.target === 'C#'
        const isAs = blackKeyIndex === asharpIdx && round.target === 'A#'
        if (!isGs && !isCs && !isAs) {
        ...
        setStreak((s) => {
          ...
          if (next >= VERIFICATION_TARGET && classicExerciseIdRef.current === 59) {
            window.setTimeout(() => {
              classicExerciseIdRef.current = 60
              setClassicExerciseId(60)
              rollVerificationHalf(verificationHalfRef)
                ...
                : slot.kind === 'fsharp'
                  ...
                  : slot.kind === 'csharp'
                    ...
                    : slot.kind === 'asharp'
                      ? asharpIdx
                      : -1
          const blackInPair = (bi) =>
            slotBlackIdx(slot0) === bi || slotBlackIdx(slot1) === bi
          const pairHasBlack =
            slotBlackIdx(slot0) >= 0 || slotBlackIdx(slot1) >= 0

          if (!blackInPair(blackKeyIndex)) {
            frozenRef.current = true
            handleWrongAnswer()
            return
          }
